...
* We will use __bootstrapping__ to understand how stable (or how variable)
...
Both the bootsrap and cross-validation are build on top of a "resample" object. In modelr, you can access these low-level tools directly with the `resample_*` functions. 
...
*   `bootstrap()` returns a data frame with two columns:
